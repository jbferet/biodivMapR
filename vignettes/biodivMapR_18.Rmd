---
title: "COPERNICUS & biodiv #5/6: Apply biodivMapR on S2"
...
Ce tutoriel intitulé  [Compute diversity from user-defined set of layers](https://jbferet.github.io/biodivMapR/articles/biodivMapR_09.html) décrit pas à pas comment calculer ces indices spectraux, puis les utiliser avec les mêmes fonctions que précédemment, en evitant toutefois la phase de transformation spectrale et la sélection de composantes. 
