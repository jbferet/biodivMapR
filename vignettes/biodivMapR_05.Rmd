...
options <- set_options_biodivMapR(fun = 'biodivMapR_tiling', options = NULL)
...
`biodivMapR` can run directly using a unique function `biodivMapR_tiling`, 
as illustrated in the code hereafter. 

```{r run biodivMapR}
# run biodivmapR on tiles defined when processing prosail inversion
ResDiv <- biodivMapR_tiling(feature_dir = prosail_dir, 
