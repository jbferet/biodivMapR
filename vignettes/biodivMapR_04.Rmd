---
title: "validation / comparison with ground observation / intercomparison"
...
with string correlation between shannon and hill indices obtained from the two 
types of data. 
However, the type of features used to compute spectral diversity influences
Bray Curtis dissimilarity. 
The correlation of the Bray Curtis dissimilarity matrix remains moderate to strong. 
