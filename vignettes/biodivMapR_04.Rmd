...
users should favor correlation analyses, rather than using error with measured 
biodiversity indices. 

The choice of the number of clusters is an important factor directly influencing 
the range of the spectral $\alpha$ diversity metrics, higher number of clusters 
leading to higher maximum potential values of spectral richness & Shannon index.
