...
<img src="../man/figures/SiteRGB.png" width="70%" height="70%" class="center">
...
It will be used in the final step of the tutorial ([**How to perform validation?**](https://jbferet.github.io/biodivMapR/articles/biodivMapR_08.html){target="_blank"}.).
...
output_dir_val <- file.path(output_dir_s2, 'GroudData')
