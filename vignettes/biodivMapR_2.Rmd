...
The image is [ready to process](https://jbferet.github.io/biodivMapR/articles/biodivMapR_1.html){target="_blank"}, parameter setting for `biodivMapR` can start. 
...
Once parameterization has been set, the image processing can start, first with an optional [radiometric filtering](https://jbferet.github.io/biodivMapR/articles/biodivMapR_3.html){target="_blank"}.
