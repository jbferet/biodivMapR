...
[Please check the full tutorial pages to get instructions, data and code examples to run `biodivMapR`](https://jbferet.github.io/biodivMapR/articles/biodivMapR_1.html){target="_blank"} can be applied.
