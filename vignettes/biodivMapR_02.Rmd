...
insufficient masking of irrelevant pixels may lead to poor estimation of 
vegetation diversity: interfaces between vegetation non-vegetated regions (soil, 
artificial surface, water) will show very high local spectral heterogeneity, 
possibly leading to high spectral diversity, unrelated to species diversity. 
...
As describe above, several procedures can be applied in order to produce 
features which will feed `biodivMapR`.
...
We consider spectral indices as a good trade-off when using Sentinel-2 data, 
given the straightforward computation and the possibility to relate these 
