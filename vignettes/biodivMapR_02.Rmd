...
hdr_path <- system.file('extdata', 'HDR', 'SENTINEL_2.hdr', 
                        package = 'biodivMapR')
sensor_bands <- read_envi_header(hdr_path = hdr_path)$wavelength
...
url <- "https://gitlab.com/jbferet/myshareddata/-/raw/master/biodivMapR_vignette_illustrations/02_pca_anim.gif"
knitr::include_graphics(url)
```

<center>
  Fig. 1. color composition of principal components computed from sentinel-2
  acquisition. 
...
<!-- </p> -->
```{r, eval=TRUE, echo = FALSE, out.width="100%"}
url <- "https://gitlab.com/jbferet/myshareddata/-/raw/master/biodivMapR_vignette_illustrations/02_grid_si.png"
knitr::include_graphics(url)
```
<center>
...
```{r, eval=TRUE, echo = FALSE, out.width="100%"}
url <- "https://gitlab.com/jbferet/myshareddata/-/raw/master/biodivMapR_vignette_illustrations/02_si_anim.gif"
knitr::include_graphics(url)
```
<center>
