...
# Florian de Boissieu <florian.de-boissieu@teledetection.fr>
#
...
Output_Dir <- 'biodivMapR_Example/03_RESULTS_specdiv' # fill with your own path
...
PartitionSpectralDiversity <- map_partition_div(Original_Image_File = Input_Image_File, 
                                                Partition_File = PCA_Output$PCA_Files,
...
vect <- 'biodivMapR_Example/01_DATA/S2A_T33NUD_Plots'
Shannon_All <- list()
