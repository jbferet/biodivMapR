...
save_diversity_maps_mw <- function(
    input_raster_path, ab_div_metrics, alpha_metrics = 'shannon', Hill_order = 1,
    Beta_info = NULL, beta_metrics = 'bray', fd_metrics = NULL, input_rast,
    output_dir, output_raster_name = NULL, window_size, filetype = 'GTiff',
    buffer_mw = TRUE){
