...
#' @param Functional list. alpha diversity metrics: richness, shannon, simpson
...
get_raster_functional <- function(input_raster_path,
                                  input_mask_path = NULL,
                                  SelectBands = NULL, Functional = c('FRic', 'FEve', 'FDiv'),
                                  window_size, maxRows = NULL,
                                  pcelim = 0.02, nbCPU = 1, MinSun = 0.25){
  message('Compute functional diversity metrics for full rasters')
